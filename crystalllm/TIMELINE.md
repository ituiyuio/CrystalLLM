...
| **v23** | (pending) | M8 扩数据 | 1893→N, 等待数据 | — | 目标 PPL <4.0 |
...
### 9.4 训练日志与报告
- `training_log_v3.md` / `v4.md` / `v5.md` / `v6.md` (旧路线)
- `v19.5_results.md` (4 维基准)
- `v20a_results.md` (229M 报告)
- `v21_results.md` (500M 报告)
- `v22a_results.md` (256z 报告)
- `v23_timeline.md` (扩数据计划)

### 9.5 权重
- `proto_v195_pure_ar.pt` (87M baseline)
- `proto_v20a_decoder.pt` (229M BAD-DP)
- `proto_v215_pure_ar_500m.pt` (475M baseline)
- `proto_v21_decoder.pt` (475M BAD-DP)
- `v22_encoder.pt` (256 维 encoder)
- `v22_diffusion_prior.pt` (6.58M prior)
- `v22_decoder.pt` (475M BAD-DP warm-start)
- `diffusion_prior.pt` (v19 826K prior)
